...
> Only project collaborator and above can create records.
...
1. Create directly
2. Create by copy / move records
3. Create through device data collection
...
## Create through device data collection
