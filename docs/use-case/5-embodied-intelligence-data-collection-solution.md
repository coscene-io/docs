...
2. **安装 cobridge**
   ...
   - 安装命令：
     ...
     ```
   - 也可参考[通过 apt 安装刻行端侧软件](https://docs.coscene.cn/docs/client/apt-source-install)
...
## 数据应用
当我们需要使用审核通过的数据时，我们可以在**项目**中查看数据，通过**标签** 、 **自定义字段** 实现对数据的筛选点击，选择记录后 点击**下载**，即可下载数据，也可分享给其他团队成员。
